---
name: video-erasure
description: This skill should be used when users need to remove hard-coded subtitles from videos while maintaining video quality and seamless visual continuity. It uses advanced AI vision recognition and image inpainting to intelligently reconstruct the background behind subtitles.
---
...
Remove hard-coded subtitles from videos using intelligent image inpainting and AI vision recognition. Supports normal and advanced erasure modes for different subtitle complexities.

## When to Use This Skill

Use this skill when:
- Removing hard-coded subtitles from videos
- Preparing videos for subtitle replacement
- Restoring original video content without subtitle overlays
- Handling different subtitle complexities (normal vs advanced)
- Preserving video quality during subtitle removal

## Core Workflow

The video-erasure skill handles the following workflow:
...
- `task_type`: "video-erasure" - Type of processing task
