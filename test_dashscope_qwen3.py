#!/usr/bin/env python3
"""
DashScope Qwen3-Omni-Flash 测试脚本
"""
...
def test_subtitle_extraction():
    ...
    try:
        from dashscope_qwen3_subtitle_extractor import DashScopeQwen3SubtitleExtractor
        
        # 创建提取器
        extractor = DashScopeQwen3SubtitleExtractor("sk-88bf1bd605544d208c7338cb1989ab3e")
...
def main():
    """主测试函数"""
    print("🧪 DashScope Qwen3-Omni-Flash 集成测试")
    print("=" * 50)
